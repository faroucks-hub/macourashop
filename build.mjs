...
for (const file of ['index.html','styles.css','interface.css','app.js','variants.mjs','commerce.mjs','operations.mjs','storefront.mjs','manifest.webmanifest','service-worker.js']) await cp(file, `dist/${file}`);
...
for(const file of ['index.html','styles.css','interface.css','app.js','variants.mjs','commerce.mjs','operations.mjs','storefront.mjs','manifest.webmanifest','service-worker.js'])await cp(file,'public/'+file);
